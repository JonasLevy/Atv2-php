                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-primary">
                            <a class="text-light" href="excluirProduto.php?cod=<?=$key?>">Excluir Produto</a> 
                          </button>
                        </div>
                      </div>
                    </div>
        ...
        <div class="modal-content">
          ...
          <form action="recebeProduto.php" method="post">
            <div class="modal-body">
              <div class="row g-3">
                <div class="col">
                  <input type="text" class="form-control" placeholder="Código" aria-label="First name" name="codigo" required value="<?= $cod?>">
                </div>
                <div class="col">
                  <input type="text" class="form-control" placeholder="Nome" aria-label="Last name" name="nome" required>
                </div>
              </div>

              <div class="row g-3 my-2">
                <div class="col ">
                  <input type="text" class="form-control" placeholder="Estoque" aria-label="First name" name="estoque" required>
                </div>
                <div class="col ">
                  <input type="text" class="form-control" placeholder="Preço" aria-label="Last name" name="preço" required>
                </div>
                <div class="col">
